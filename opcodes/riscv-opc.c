...
/*new instructions*/
{"regsw",       0, INSN_CLASS_I, "d,s,t" ,    MATCH_REGSW, MASK_REGSW, match_opcode, 0 },
{"regsw_c",     0, INSN_CLASS_I, "t,q(s)",    MATCH_REGSW_C, MASK_REGSW_C, match_opcode, INSN_DREF|INSN_4_BYTE },
